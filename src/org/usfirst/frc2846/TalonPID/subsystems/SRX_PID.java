...
package org.usfirst.frc2846.TalonPID.subsystems;
...
public class SRX_PID extends Subsystem {
    ...
    private final Encoder quadratureEncoder1 = RobotMap.sRX_PIDQuadratureEncoder1;
    private final CANTalon cANTalon1 = RobotMap._talon;
    ...
    public void setSetpointRPS(double speed)
    {
    	...
    	double targetSpeed = speed * 5000d;//pulses per 100ms?? ie 1700 or 4000rpm, which way is it??? Someone sneak in a conversion??
